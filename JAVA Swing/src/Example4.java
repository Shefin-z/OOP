...
public class Example4 extends JFrame {
    ...
    nm.setBounds(10, 20, 50, 20);  add(nm);
    nmtf.setBounds(60, 20, 200, 20);  add(nmtf);
    gen.setBounds(10, 50, 50, 20);  add(gen);
    ml.setBounds(60, 50, 80, 20);
    add(ml);
    fml.setBounds(140, 50, 100, 20);  add(fml);
    note.setBounds(10, 80, 40, 20);  add(note);
    jsp.setBounds(60, 80, 200, 120);
    add(jsp);
    submit.setBounds(180, 210, 80, 20);  add(submit);
    setVisible(true);
